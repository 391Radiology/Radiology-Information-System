	...
	?>
		...
		<?php
			...
			foreach ($modes as $mode => $value) {
				...
				// Admin can use create, manage, doctor, generate and analysis 
				// Radiologist can use upload
				if ($mode == "account" or $mode == "search" or ($type == "a" and ($mode == "create" or $mode == "manage" or $mode == "doctor" or $mode == "generate" or $mode == "analysis")) or ($type == "r" and $mode == "upload")) {
				?>
